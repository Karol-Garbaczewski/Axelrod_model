...
\begin{document}
	...
	Autor proponuje nowatorski model odmienny od dotychczasowych, które 
	...
	\begin{enumerate}
		...
		\item Modyfikacja cechy: agent losowo przyjmuje jedną cechę sąsiada, czyli zwiększa podobieństwo kulturowe.
	\end{enumerate}
...
<<<<<<< HEAD
	Z łatwych rzeczy, przyjemnie się implementowało samą podstawę modelu klasy \emph{Agent} i \emph{Model}.
=======
	Z łatwych rzeczy, fajnie się implementowało samą podstawę modelu klasy \emph{Agent} i \emph{Model}.
>>>>>>> 9ba7b6b0e9d31980474bc701bef6767cd7830703
