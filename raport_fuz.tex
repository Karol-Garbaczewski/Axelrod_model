...
\begin{document}
    ...
    \subsection{Model standardowy}
        ...
        W celu zobrazowania, wizualnego zrozumienia, na rys. 1 przedstawiony jest efekt pełnej pojedynczej symulacji przebiegu modelu. Większość siatki została zaabsorbowana przez jedną kulturę i wytworzyły się cztery wyspy kultur. Tutaj ustaliliśmy trzy cechy po sześć wariantów na siatce \(15 \times 15\). W przeważającej części symulacji wyspy pojawiały się wyłącznie na brzegach, co może być spowodowane mniejszą liczbą sąsiadów, a więc mniejszą szansą na wymianę cech.
        ...
        Proces asymilacji dobrze widać na rys. 5. Intuicyjnie, podobieństwo agentów rośnie wraz z czasem. Tym samym liczba odróżnialnych kultur maleje tu jeszcze work in progress
